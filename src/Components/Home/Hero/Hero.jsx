...
export default function Hero() {
    ...
    return (
        ...
        <section ref={containerRef} className="relative min-h-[100vh] flex flex-col justify-center items-center overflow-hidden bg-customBg pt-20 pb-32">
            ...
            <div className="hero-img-1 absolute top-[-5%] left-[-5%] md:top-[-10%] md:left-[-2%] w-[45vw] md:w-[28vw] max-w-[450px] hero-float hero-img-fade z-10 pointer-events-none">
                <img src="https://spicaware.com/wp-content/uploads/2024/12/shapes-1.png" alt="Abstract Brown Shape" className="w-full h-auto object-contain" />
            </div>
            ...
            <div className="hero-img-2 absolute top-[15%] right-[-15%] md:top-[5%] md:right-[-8%] w-[55vw] md:w-[38vw] max-w-[650px] hero-float hero-img-fade z-10 pointer-events-none">
                <img src="https://spicaware.com/wp-content/uploads/2024/12/shapes-2.png" alt="Abstract Green Shape" className="w-full h-auto object-contain" />
            </div>
            ...
            <div className="hero-img-3 absolute bottom-[5%] left-[-10%] md:bottom-[-5%] md:left-[-5%] w-[50vw] md:w-[35vw] max-w-[600px] hero-float hero-img-fade z-10 pointer-events-none">
                <img src="https://spicaware.com/wp-content/uploads/2024/12/shapes-3.png" alt="Abstract White Shape" className="w-full h-auto object-contain" />
            </div>
            ...
            <div className="hero-img-5 absolute bottom-[23%] right-[20%] md:right-[33%] w-[12vw] md:w-[8vw] max-w-[150px] hero-float hero-img-fade z-20 pointer-events-none">
                <img src="https://spicaware.com/wp-content/uploads/2024/12/shapes-5.png" alt="Small Knot Shape" className="w-full h-auto object-contain" />
            </div>

            <div className="text-since relative z-4 text-center flex flex-col items-center justify-center mt-4 md:mt-0 select-none mix-blend-difference md:mix-blend-normal py-20">
